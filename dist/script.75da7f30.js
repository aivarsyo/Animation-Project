...
function moveCarParts() {
  ...
  function _NextMovement(part) {
    ...
    part.gsap = _gsap.gsap.to(part, random(5, 10), {
      x: randX / 20,
      y: randY / 20,
...
function importAssemblyLine() {
  return _importAssemblyLine.apply(this, arguments);
}

function _importAssemblyLine() {
  _importAssemblyLine = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2() {
    var FordLogo;
...
function fordLogoClicked() {
  return _fordLogoClicked.apply(this, arguments);
}

function _fordLogoClicked() {
  _fordLogoClicked = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee3() {
    var response, mySvgData;
    return _regenerator.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return fetch("assemblyLine2.svg");
...
function continueFordClicked() {
  var assemblyLine = document.createElementNS('http://www.w3.org/2000/svg', 'use');
  ...
  _gsap.gsap.killTweensOf(parts);

  _gsap.gsap.to(parts, {
    y: function y(index, element) {
...
function importsMainInfo() {
  return _importsMainInfo.apply(this, arguments);
}

function _importsMainInfo() {
  _importsMainInfo = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4() {
    var response, mySvgData;
...
function showsMainInfo() {
  var mainInfo = document.createElementNS('http://www.w3.org/2000/svg', 'use');
...
function redButtonClicked() {
  ...
  function introScreenDisappears() {
    _gsap.gsap.killTweensOf(engines);

    var allSvgs = document.querySelectorAll("#CarParts");

    _gsap.gsap.to(allSvgs, 2, {
      opacity: 0,
      onComplete: function onComplete() {
        importsSecondScene();
      }
...
function importsSecondScene() {
  return _importsSecondScene.apply(this, arguments);
}

function _importsSecondScene() {
  _importsSecondScene = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee5() {
    var response, mySvgData, response2, mySvgData2, response3, mySvgData3;
...
function importFilesForFlags() {
  return _importFilesForFlags.apply(this, arguments);
}

function _importFilesForFlags() {
  _importFilesForFlags = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee7() {
    var response, mySvgData;
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 5:
            ...
            fetch('carInfo.json').then(function (response) {
...
function oneFlagClicked(data) {
  console.log(data);
  var flag = document.getElementById("".concat(data.id));
  ...
  function clickFlag() {
    var bigEngine = document.querySelector("#modalEngine > svg");
    var containerOfEngine = document.querySelector("#modalEngine");
    var textOfModal = document.querySelector("#engineModal > g > text:nth-child(4)");
    var titleOfModal = document.querySelector("#engineModal > g > text:nth-child(6)");
    ...
    document.querySelectorAll("#titleOfModal, #descOfModal").forEach(function (element) {
      d3plus.textwrap().container(d3.select(element)).resize(true).draw();
    });
  }
}
