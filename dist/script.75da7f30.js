...
function showSecondSceneSvgs() {
  var car = document.createElementNS('http://www.w3.org/2000/svg', 'use');
  car.setAttribute("href", "#FordCar");
  document.querySelector("#backgroundSecondScene").appendChild(car);
  var pedals = document.createElementNS('http://www.w3.org/2000/svg', 'use');
